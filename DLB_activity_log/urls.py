...
urlpatterns = patterns('',
    ...
    url(r'^create_dataset/', NewDataset.as_view(), name='create_dataset'),
    url(r'^create_batch/', NewBatch.as_view(), name='create_batch'),
    url(r'^create_linker/', NewLinker.as_view(), name='create_linker'),
    url(r'^create_dluid/', NewDLUID.as_view(), name='create_dluid'),
    url(r'^create_client/', NewClient.as_view(), name='create_client'),
